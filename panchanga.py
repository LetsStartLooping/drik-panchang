...
def lunar_phase(jd):
  ...
  # print(solar_long)
  moon_phase = (lunar_long - solar_long) % 360
  # moon_phase = tuple(map(operator.sub, lunar_long, solar_long)) % 360
  return moon_phase
...
# Halifax:44.64533:-63.57239:America/Halifax


  today = gregorian_to_jd(Date(2021, 10, 18))
  location = Place(44.64533, -63.57239, -4.0)
  print("Tithi: ", tithi(today, location))
  print("Nakshatra: ", nakshatra(today, location))
  print("Moon Rise: ", moonrise(today, location))
  print("Moon Set: ", moonset(today, location))
  print("Sun Rise: ", sunrise(today, location))
  print("Sun Set: ", sunset(today, location))
  print("Samvat :", lunar_phase(today))
